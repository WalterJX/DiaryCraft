...
//本类用于图墙功能模块中对图片的放大缩小平移，和双击进入详情页的功能
...
public class ZoomImageView extends View {
    ...
    private ImageDetailsActivity imageDetailsActivity;

    public ZoomImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        currentStatus = STATUS_INIT;//将当前操作状态设为STATUS_INIT。
    }

    public void setImageBitmap(Bitmap bitmap) {//将待展示的图片设置进来。
        sourceBitmap = bitmap;
        invalidate();
    }
        ...
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_DOWN:
                if (mPreviousUpEvent != null && mCurrentDownEvent != null
                    ...
                    imageDetailsActivity.startNoteInfoActivity();//双击进入详情页
                }
    ...
    //计算两个手指之间的距离。distance between finger
    ...
    //计算两个手指之间中心点的坐标。calculate coordinates
    ...
    public void setActivity(ImageDetailsActivity imageDetailsActivity){
